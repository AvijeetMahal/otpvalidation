...
const {userData} = useContext(AppContext)
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        className='w-36 h-36 rounded-fll mb-6'/>
        ...
        <button navigate="/login" className='border border-gray-500 rounded-full px-8 py-2.5 hover:bg-gray-100 transition-all'>Get Started</button>
    </div>
  )
}
